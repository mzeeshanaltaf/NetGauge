...
export function ContactForm({ initialSuccess = false, initialError }: Props) {
  ...
  // The field name is deliberately non-semantic so browser/autofill doesn't
  // recognise it as a real field and pre-populate it for real users.
    ...
    return (
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-primary/20 bg-primary/5 px-6 py-12 text-center">
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          Thanks for reaching out — we read every message and will get back to you if a reply
          is needed.
        </p>
        <button
          type="button"
